...
var localWindowsSSHProvisionBootstrapPowerShell = mustLoadLocalWindowsPowerShellAssets(localWindowsManagedUserScriptPath, localWindowsSSHBootstrapScriptPath)
var localWindowsSSHProvisionCleanupPowerShell = mustLoadLocalWindowsPowerShellAssets(localWindowsManagedUserScriptPath, localWindowsSSHCleanupScriptPath)
