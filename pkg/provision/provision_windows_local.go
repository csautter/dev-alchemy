...
const (
	...
	localWindowsBootstrapScriptAssetPath  = "scripts/windows/local-windows-provision-bootstrap.ps1"
	localWindowsCleanupScriptAssetPath    = "scripts/windows/local-windows-provision-cleanup.ps1"
)
...
var localWindowsProvisionBootstrapPowerShell = mustLoadLocalWindowsPowerShellAsset(localWindowsBootstrapScriptAssetPath)
var localWindowsProvisionCleanupPowerShell = mustLoadLocalWindowsPowerShellAsset(localWindowsCleanupScriptAssetPath)
