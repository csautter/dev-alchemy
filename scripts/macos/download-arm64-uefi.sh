...
if [ ! -f "${SCRIPT_DIR}"/../../vendor/qemu-efi-aarch64_${qemu_efi_version}_all.deb ]; then
	...
	curl --insecure -o "${SCRIPT_DIR}"/../../vendor/qemu-efi-aarch64_${qemu_efi_version}_all.deb -L https://ftp.de.debian.org/debian/pool/main/e/edk2/qemu-efi-aarch64_${qemu_efi_version}_all.deb
else
